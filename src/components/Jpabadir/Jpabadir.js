        ...
        <div className='d-flex justify-content-center'>
          <Row style={{ maxWidth: '1700px' }} >
            <Col md={{ span: 8, order: 1 }} style={{ order: 2 }}>
              ...
              <br />
              <br />
              I am passionate about building excellent software and committed to offering the best possible experience to our clients. I firmly in the power of technology to transform organizations, and excited to help our partners leverage it to achieve their goals.
