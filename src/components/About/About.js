      ...
      <Container fluid className="AboutContainer">
        <Row>
          ...
          <Col md={4}>
            ...
            <div style={{ fontSize: '28px', marginTop: '30px', fontWeight: 'bold' }}>What we do</div>
          ...
          <Col md={4}>
            ...
            <div style={{ fontSize: '28px', marginTop: '30px', fontWeight: 'bold' }}>Who we work with</div>
          ...
          <Col md={4}>
            ...
            <div style={{ fontSize: '28px', marginTop: '30px', fontWeight: 'bold' }}>Our process</div>
            <p>
