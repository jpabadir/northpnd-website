      ...
      <Container fluid>
        <Row className="justify-content-center">
          ...
          <WorkCard
            link="digitalrise.be"
            title="Digital Rise"
            subtitle="We helped Digital Rise build an interactive prototype for their project. Our collaboration allowed them to obtain a functional prototype within a week.">
          </WorkCard>
        </Row>
      </Container>
    </div>
