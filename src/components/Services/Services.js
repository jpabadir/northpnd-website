    ...
    <Container fluid>
      <Row className="ServicesCardsRow">
        ...
        <ServicesCard
          ...
          subtitle="We provide staff augmentation services to our technical clients. We are an integral part of their team, working closely with their developers. We emphasize collaboration, communication, and code quality. We pride ourselves in working with a deep sense of ownership toward the outcome of the tech we build. We strive to create scalable, maintainable, robust solutions that exceed expectations."
