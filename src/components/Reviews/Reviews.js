  ...
  const reviews = [
    {
      ...
      author_url:
        "https://www.google.com/maps/contrib/116340316200654309946/reviews",
      language: "en",
      profile_photo_url:
        "https://lh3.googleusercontent.com/a-/AD5-WCkHLRjS2mVv6rxBVSpob4_c4jpIapdMUonxXBSDcQ=s128-c0x00000000-cc-rp-mo",
      rating: 5,
    ...
    },
    {
      ...
      author_url:
        "https://www.google.com/maps/contrib/101035291913459025693/reviews",
      language: "en",
      profile_photo_url:
        "https://lh3.googleusercontent.com/a/AEdFTp6lsfDq0k6YBRBfatRKorBipQ_4HFF8stJ6qXJE=s128-c0x00000000-cc-rp-mo",
      rating: 5,
  ...
  return (
    <div>
        ...
        {reviews.map((review, index) => {
          return (
            <Col className="Review" key={review.text}>
              ...
              <div>
                {review.author_name}
                {Boolean(companies[index]) && `, ${companies[index]}`}
              </div>
            </Col>
          );
        })}
      ...
      <div className="ReadOnGoogle pt-4">
        <a
          href="https://www.google.com/maps/place/North+P%26D,+Inc./@43.6558696,-79.3841034,17z/data=!3m1!4b1!4m5!3m4!1s0x882b35f52d58bc1d:0x1f2d801c9f15617a!8m2!3d43.6558657!4d-79.3819147/reviews"
          target="_blank"
