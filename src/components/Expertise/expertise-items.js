export const items = [
  ...
  { "client": "Midstride Technologies", "tech": ["PHP", "Laravel", "MySQL", "Vue", "JS"], "description": "Currently building many full-stack features.", "tags": ["full-stack web dev"], "dates": "Jan 2022 - Ongoing" },
