    ...
    <div>
      ...
      <ul>
        ...
        <ul>
          ...
          <li><i>Local</i>: this is your local machine, which you'll usually access using <strong>localhost:3000</strong> in the browser. You'll typically run the entire application locally so that you can make changes and view their effect instantantly and test them before "deploying" to production.</li>
