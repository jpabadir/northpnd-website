export const items = [
  ...
  { "client": "Midstride Technologies", "tech": ["PHP", "Laravel", "MySQL", "Vue", "JS"], "description": "Built many full-stack features.", "tags": ["full-stack web dev"], "dates": "Jan 2022 - Ongoing" },
  { "client": "Midstride Technologies", "tech": ["GitHub Actions"], "description": "Built and maintained a CI/CD pipeline allowing to automatically test and lint code before any PR gets merged.", "tags": ["devops", "CI/CD", "automation"], "dates": "February 2022 - Ongoing" },
  ...
  { "client": "Internal Project", "tech": ["React", "DNS Configuration"], "description": "Built this website!", "tags": ["full-stack web dev"], "dates": "May 2021 - Ongoing" }
]
